...
═══════════════════════════════════════════════════════════
PAST CONVERSATION SUMMARY — compressed history of older chats
═══════════════════════════════════════════════════════════
{past_summary[:2000]}

This gives you context about what was discussed before the current
conversation window. Reference it when the farmer refers to past topics."""
